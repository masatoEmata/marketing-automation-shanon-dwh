...
, prompt_generation as (
    ...
    select
        ...
        , CONCAT(
            ...
            , '   - 自由記述がある場合は、（指示の「2」に従い）その内容をポイントを押さえて短くまとめてください。\n\n'
            ...
            , '3. 改善点については、可能であれば具体的な背景や対処案を示す。\n'
            ...
            , '＜設問1: 「コミュニケーション能力の評価」＞\n'
            , '選択肢ID: 2（4.やや満足）\n'
            , '自由記述: 「コーチの声掛けが丁寧で助かっていますが、\n'
            , '           最近は人数が増えて、一人ひとりを十分に見られない場面が増えてきたと感じます。\n'
            , '           もう少しサポート体制を増やしてほしいです。」\n\n'
            , '＜設問2: 「活動内容に関するご意見」＞\n'
            , '自由記述: 「練習メニューが増員に追いついておらず、\n'
            , '           子ども同士のぶつかりが多くなっているようです。\n'
            , '           また、会場までの道が分かりづらく、迷子になる人がいます。\n'
            , '           安全対策として案内板や誘導の強化を検討してほしいです。」\n\n'

            , '---(例示 期待する出力)---\n'
            , '(A) 設問ごとのまとめ\n'
            , '・【設問1】コミュニケーション能力の評価 → 選択肢：4.やや満足\n'
            , '   自由記述: 「コーチの声掛けが丁寧だが、人数増により一人ひとりを見きれない」\n'
            , '   → 改善要望: 「サポート体制を増やしてほしい」\n\n'
            , '・【設問2】活動内容に関するご意見\n'
            , '   自由記述: 「練習メニューの人数対応が不十分」「会場への道が分かりづらく迷子が出ている」\n'
            , '   → 改善要望: 「安全対策として案内板や誘導を強化」\n\n'
            ...
            , ' - 改善点:\n'
            , '   - 練習メニューが増員に追いついていない\n'
            , '   - 会場までの誘導がわかりづらく、安全面が課題\n'
            , '   - 案内板などを使った誘導体制の整備\n\n'
            , '【その他】\n'
            , ' - 良かった点: なし\n'
            , ' - 改善点: なし\n\n'
            , '【要注意事項】\n'
            , ' - 人数増加への対応不足により、安全面や指導面で問題が拡大する可能性\n'
            , ' - 早期に対策を検討する必要あり\n\n'
